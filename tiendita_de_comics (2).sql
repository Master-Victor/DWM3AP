...
-- Tiempo de generación: 05-10-2023 a las 15:59:47
...
--
-- Volcado de datos para la tabla `comic_x_personaje`
--

INSERT INTO `comic_x_personaje` (`id`, `id_comic`, `id_personaje`) VALUES
(1, 2, 20),
(2, 12, 3),
(3, 1, 20),
(5, 11, 68);
...
--
-- Indices de la tabla `comic_x_personaje`
--
ALTER TABLE `comic_x_personaje`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `comic_x_personaje`
--
ALTER TABLE `comic_x_personaje`
...
--
-- Filtros para la tabla `comic_x_personaje`
--
ALTER TABLE `comic_x_personaje`
  ADD CONSTRAINT `comic_x_personaje_ibfk_1` FOREIGN KEY (`id_personaje`) REFERENCES `personajes` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `comic_x_personaje_ibfk_2` FOREIGN KEY (`id_comic`) REFERENCES `comics` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
